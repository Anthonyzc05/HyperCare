/* ============================================
   icons.jsx — Iconos de línea compartidos
   Portal HTA · usar en src/components/icons.jsx
   ============================================ */
...
export function IconPill(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <rect x="3.5" y="10.2" width="17" height="7.6" rx="3.8" transform="rotate(-45 12 14)" />
      <path d="M9.5 10.5 14 15" />
    </svg>
  );
}
...
export function IconBell(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M6 10a6 6 0 1 1 12 0c0 3.4 1 5 1.6 5.8H4.4C5 15 6 13.4 6 10Z" />
...
export function IconDroplet(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 3.5s6 6.7 6 11.2a6 6 0 1 1-12 0c0-4.5 6-11.2 6-11.2Z" />
    </svg>
  );
}
